...
st.set_page_config(page_title="Content Researcher & Writer", page_icon="ʭ", layout="wide")

# Title and Markdown
st.title("Content Research and writer :- Powered by CrewAI")
st.markdown("Generating blog post and UI using Agentic AI")
...
def generate_content(topic):
    ...
    senior_research_analyst = Agent(
        ...
        backstory="Research, analyze, and synthesize comprehensive information on (topic) from reliable web sources"
    ...
    crew = Crew(
        ...
        Task = [research_task, writing_task],
        verbose= True
    )
